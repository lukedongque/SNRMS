        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stations_Hospitals_HospitalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupId = table.Column<int>(type: "int", nullable: false),
                    StationId = table.Column<int>(type: "int", nullable: false),
                    DaySlot = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RotationAssignments", x => x.RotationAssignmentId);
                    table.ForeignKey(
                        name: "FK_RotationAssignments_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "GroupId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RotationAssignments_Stations_StationId",
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "InstructorId", "PasswordHash", "Role", "StudentId", "Username" },
                values: new object[] { 1, null, "admin123", "Admin", null, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RotationAssignments_GroupId",
                table: "RotationAssignments",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_RotationAssignments_StationId",
                table: "RotationAssignments",
                column: "StationId");
